...
def delete(): 
    ...
    headingLabel = Label(headingFrame1, text="Delete Book", bg='white', fg='purple', font=('Courier',30,'bold'))
    ...
    addBtn = Button(root,text="DELETE",bg='white', fg='purple',command=deleteBook)
