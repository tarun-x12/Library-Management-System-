...
def bookRegister():
    ...
    insertBooks = "insert into "+bookTable+" values ('"+bid+"','"+title+"','"+author+"','"+status+"','NULL')"
    try:
...
def addBook(): 
    ...
    headingLabel = Label(headingFrame1, text="Add Books", bg='white', fg='purple', font=('Courier',30,'bold'))
    ...
    lb1 = Label(labelFrame,text="Book ID : ", bg='black', fg='white',font=('Courier'))
    ...
    lb2 = Label(labelFrame,text="Title : ", bg='black', fg='white',font=('Courier'))
    ...
    lb3 = Label(labelFrame,text="Author : ", bg='black', fg='white',font=('Courier'))
    ...
    SubmitBtn = Button(root,text="ADD",bg='white', fg='purple',command=bookRegister)
